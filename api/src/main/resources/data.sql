...
INSERT INTO posts (titulo, texto, data_criacao, id_usuario, livro, imagem) 
VALUES ('Eu amo esse livro!', 'Romance de dragão.', CURRENT_TIMESTAMP, 1, 'Fouth Wing', X'0A0B0C');

INSERT INTO post_autores (id_post, autor_livro) 
VALUES (1, 'Autora de Fouth Wing');

INSERT INTO posts (titulo, texto, data_criacao, id_usuario, livro, imagem)
VALUES ('Absolute literatura', 'Insano', CURRENT_TIMESTAMP, 3, 'Sacramentadora', X'0A0B0C');

INSERT INTO post_autores (id_post, autor_livro)
VALUES (2, 'Autora de Sacramentadora');

INSERT INTO posts (titulo, texto, data_criacao, id_usuario, livro, imagem)
VALUES ('Eu amo esse livro!', 'Romance de dragão.', CURRENT_TIMESTAMP, 3, 'Fouth Wing', X'0A0B0C');
